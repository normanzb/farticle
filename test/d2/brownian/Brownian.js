...
function(cogs, CounterSteady, CounterFixed,
    ...
    return cogs.ctor(function(){
        ...
        addInitializer( new Velocity( new Disc( new Point( 0, 0 ), 150, 100 ) ) );
        me.initializers.push( new Choose( [ air, smoke ], [30, 1] ) )

        me.actions.push( new Move() );
        me.actions.push( new Collide( 1 ) );
